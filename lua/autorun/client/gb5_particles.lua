...
game.AddParticles( "particles/gb5_antimatter_Rogue.pcf") 
...
game.AddParticles( "particles/gb5_uvbomb.pcf")
game.AddParticles( "particles/gb5_acidflask.pcf")
game.AddParticles( "particles/gb5_ioncannon.pcf")
game.AddParticles( "particles/gb5_sun_bomb.pcf")
game.AddParticles( "particles/shockwave.pcf")