...
sound.Add( {
	name = "airraid_siren_2",
	channel = CHAN_STATIC,
	volume = 1.0,
	level = 160,
	pitch = {100, 100},
	sound = "gbombs_5/sirens/airraid_siren.wav"
} )
...
local ent = ents.Create( "airraid_siren_2" )
ent:SetPos( SpawnPos )
ent:Spawn()
ent:Activate()
return ent
...
function ENT:Havok()
self:EmitSound("airraid_siren_2")
...
self.Entity:StopSound("airraid_siren_2")
