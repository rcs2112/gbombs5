...
function SWEP:DealDamage()
	...
	if ( SERVER && IsValid( tr.Entity ) && ( tr.Entity:IsNPC() || tr.Entity:IsPlayer() || tr.Entity:Health() > 0 ) ) then
		...
		dmginfo:SetDamage( math.random( 25, 52 ) )
...
function SWEP:Deploy()
	...
	ParticleEffectAttach("shadow_cast",PATTACH_POINT_FOLLOW,self.Owner,self.Owner:LookupAttachment("anim_attachment_RH"))
	ParticleEffectAttach("shadow_cast",PATTACH_POINT_FOLLOW,self.Owner,self.Owner:LookupAttachment("anim_attachment_LH"))
	self:UpdateNextIdle()
