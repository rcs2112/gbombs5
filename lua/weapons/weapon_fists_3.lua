...
function SWEP:SecondaryAttack()
	...
	if traceRes.HitWorld then
		local distance = traceRes.HitPos:Distance(self.Owner:GetPos())
		local F_dir = (self.Owner:GetPos() - traceRes.HitPos):GetNormal() * -2555
		self.Owner:SetVelocity(F_dir)
...
function SWEP:DealDamage()
	...
	if SERVER then
		...
		self.Owner:StripWeapon("weapon_fists_3")
	end
